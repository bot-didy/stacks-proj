...
import "../../contracts/Royalty/Royalty.sol";
import "../../contracts/Royalty/LibRoyalty.sol";

/// @title BlockzLaunchpad
/// @author Blockz
/// @notice Implements a simple minting NFT contract with an allowlist and public sale phase.
contract BlockzLaunchpad is ERC721, ERC721Enumerable, VRFConsumerBaseV2, Royalty, Ownable, Pausable, ReentrancyGuard {
	...
	/// @notice The fees collected by Blockz on the sale benefits
