...
/**
 * @title BlockzExchange Contract
 * @notice This contract enables users to accept offers and execute purchases of ERC721 NFTs.
 */
contract BlockzExchange is Initializable, EIP712Upgradeable, OwnableUpgradeable, PausableUpgradeable, ReentrancyGuardUpgradeable {
    ...
    event CancelAllOffers(address indexed user);
    ...
    */
    ...
    function cancelAllOffers() external whenNotPaused {
        ...
        emit CancelAllOffers(msg.sender);
    }
