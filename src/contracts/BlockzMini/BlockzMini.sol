...
contract BlockzMini is ERC721, ERC2981, ERC721Enumerable, Ownable {
    ...
    */
    ...
    /**
    * @notice allows collection owners to define an extension as a suffix to the baseURL.
    * e.g baseTokenURI = “https://blockz.gg/”;
    */
    ...
    */
    ...
    constructor(address _receiver) ERC721("Mini Blockz", "MINIBLOCKZ") {
    ...
    * e.g “https://blockz.gg/1.json”; --> baseURI + tokenId + baseExtension
    * @param _tokenId nft tokenId
    */
