...
* @notice A Template contract that can be deployed from users on Blockz.io. It allows users to mint, transfer NFT’s and define royalties.
*/
contract NFTCollectible is ERC721, ERC721Enumerable, Royalty, Ownable {
    ...
    */
    ...
    /**
    * @notice allows collection owners to define an extension as a suffix to the baseURL.
    * e.g baseTokenURI = “https://blockz.io/”;
    */
    ...
    * e.g “https://blockz.io/1.json”; --> baseURI + tokenId + baseExtension
    * @param _tokenId nft tokenId
    */
